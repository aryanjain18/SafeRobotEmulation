...
from utils import background_loader, get_ip, write_bezier_with_yaw_to_csv, calculate_piecewise_cubic_bezier_with_yaw, add_tangent_point, sub_vectors, draw_arrow
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if SAVE_PATH_BOOL:
                    ...
                    write_bezier_with_yaw_to_csv(BEZIER_POINTS, YAW_ANGLES)
